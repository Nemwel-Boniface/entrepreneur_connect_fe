...
const Features = () => {
  ...
  const displayFeatures = data.map(
    (feature) => (
      <div className="featureImage" key={feature.id}>
  ...
  return (
    <section className="FeaturesComponent">
      ...
      <div className="featuresTop">
        ...
        <p>
          Entrepreneur Connect is a platform that provides entrepreneurs with
          the tools and resources they need to connect with each other, find
          potential partners, collaborate on projects, and grow their businesses.
          With Entrepreneur Connect, you can:
        </p>
      </div>
